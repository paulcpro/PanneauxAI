...
vector<Mat> detectAndDisplayWarning( Mat frame )
{
    ...
    //-- Detect signs
    //Bug CV_HAAR_SCALE_IMAGE au lieu de CASCADE_SCALE_IMAGE
    warning_cascade.detectMultiScale( frame_gray, signs, 1.1, 3, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
...
vector<Mat> detectAndDisplayNoParking( Mat frame )
{
    ...
    //-- Detect signs
    no_parking_cascade.detectMultiScale( frame_gray, signs, 1.1, 3, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
