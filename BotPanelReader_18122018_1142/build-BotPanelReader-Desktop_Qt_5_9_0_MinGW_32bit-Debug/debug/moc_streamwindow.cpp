...
#include "../../BotPanelReader/streamwindow.h"
...
QT_MOC_LITERAL(3, 38, 21) // "on_pushButton_pressed"

    },
    "streamWindow\0on_pushButton_3_clicked\0"
    "\0on_pushButton_pressed"
};
...
const QMetaObject streamWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_streamWindow.data,
...
void *streamWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_streamWindow.stringdata0))
        return static_cast<void*>(const_cast< streamWindow*>(this));
