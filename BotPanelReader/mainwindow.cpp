    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->setupUi(this);
        ...
        //LCD
        this->ui->lcdNumber->setGeometry(20, 100, 320, 245);

        //Label image
        this->ui->lImage->setGeometry(350, 20, 430, 325 );
...
void MainWindow::on_pushButton_clicked()
{
   //Fait tout le traitement d'images sans afficher les filtres
    ...
    QString val = getCheminImage();

    for(int i=0;i<val.size(); i++) {
        if (val[i] == "3") {
                this->ui->lcdNumber->display(30);
           }
           if (val[i] == "5") {
               this->ui->lcdNumber->display(50);
           }
           if (val[i] == "7") {
               this->ui->lcdNumber->display(70);
           }
           if (val[i] == "8") {
               this->ui->lcdNumber->display(80);
           }
           if (val[i] == "9") {
