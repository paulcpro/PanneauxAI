    ...
    ui(new Ui::analyseWindow)
{
    ...
    QPixmap pixmapImg("C:/analyse.jpg");
    ...
    //Bouton Fermer
    this->ui->pushButton_2->setGeometry(350, 630 , 150 ,40);

    //Bouton Enregistrer
    this->ui->pushButton_4->setGeometry(50, 630 , 150 ,40);

    //Image original
    this->ui->lImage->setGeometry(10, 50, 250, 250);
    //label original
    this->ui->label->setGeometry(10, 15, 100, 40);
    //checkBox original
    this->ui->checkBox_4->setGeometry(90, 15, 120,40);

    //Image filtré rouge
    this->ui->label_4->setGeometry(300, 50, 250, 250);
    //label rouge
    this->ui->label_2->setGeometry(300, 20, 100, 40);
    //checkBox rouge
    this->ui->checkBox->setGeometry(430, 20, 150, 40);

    //Image filtré noir
    this->ui->lImage_3->setGeometry(10, 350, 250, 250);
    //label noir
    this->ui->label_5->setGeometry(10, 285, 100, 100);
    //box noir
    this->ui->checkBox_2->setGeometry(130, 285, 100, 100);

    //Image résultat
    this->ui->lImage_5->setGeometry(300, 350, 250, 250);
    //label result
    this->ui->label_7->setGeometry(300, 285, 110, 100);
    //box result
    this->ui->checkBox_3->setGeometry(430, 285, 100, 100);
    ...
    */
    ...
    std::string imageRougeC = imageRouge.toLocal8Bit().constData();
       ...
       for( size_t i = 0; i < circles.size(); i++ )
       {
           ...
           /******* AJOUT DANY YACINE *******/
           //On va cloner l'image pour avoir une copie qu'on rognera
           ...
           Mat clone(src2, Rect(center.x-radius, center.y-radius, radius*2, radius*2));
                      ...
                      QFile file("image.png");     //clone
                                 ...
                                 cvtColor(clone, teinteClone, COLOR_BGR2HSV );
                                 ...
                                 inRange(clone, Scalar(0, 0, 0), Scalar(80, 80, 80), maskClone);
                                 /**************************/

                      //Sauvegarde du filtre noir
                      imwrite("C:/Resources/PanneauxAI/filtreNoir.jpg", maskClone);
            /*********************************/
       }
    ...
    QPixmap *pixmap_img3 = new QPixmap("C:/Resources/PanneauxAI/filtreCercle.jpg");
    this->ui->lImage_3->setPixmap(pixmap_img3->scaled(x2,y2));

    //Affichage de l'image une fois filtré noir dans le label
    int x5 = this->ui->lImage_5->width();
    int y5 = this->ui->lImage_5->height();
    QPixmap *pixmap_img5 = new QPixmap("C:/Resources/PanneauxAI/filtreNoir.jpg");
